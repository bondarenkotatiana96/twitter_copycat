...
const modalExit = document.querySelector(".login-modal i");
...
const postModalExit = document.querySelector(".modal-header i");
...
postModalExit.addEventListener("click", () => {
